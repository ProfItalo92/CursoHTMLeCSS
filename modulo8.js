...
function submitQuiz() {
    ...
    const correctAnswers = {
        q1: 'a',  // font-size altera o tamanho da fonte
        q2: 'a',  // word-spacing altera o espaçamento entre palavras
        q3: 'a',  // text-shadow adiciona uma sombra no texto
        q4: 'a',  // background-clip: text aplica um gradiente no texto
        q5: 'a'   // text-transform altera a caixa do texto
    };
...
function goToNextModule() {
    window.location.href = 'modulo9.html';  // Redireciona para o Módulo 9
}
